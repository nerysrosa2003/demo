        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}}>
                <KeyboardAwareScrollView style = {{width: '90%'}}>
                    ...
                    />
                    <View style = {styles.component_view} onStartShouldSetResponder={() => this.props.navigation.navigate("SelectHospital", {prev_screen: "VisitMaster"})}>
                        <View style = {styles.component_title_view}>
                    ...
                    <View style = {styles.component_view} onStartShouldSetResponder={() => this.props.navigation.navigate("SelectDoctor", {prev_screen: "VisitMaster"})}>
                        <View style = {styles.component_title_view}>
                            <Text style = {styles.component_title_text}>Select Doctor</Text>
                        </View>
                        <View style = {styles.component_content_view}>
                            <TextInput style = {[styles.component_content_text, {padding: 0}]} editable={false} pointerEvents="none" placeholder = {"Select Doctor"}>{this.state.doctorName}</TextInput>
                        </View>
                    </View>
                    <View style = {[styles.component_view, {borderBottomColor: '#de9d73', borderBottomWidth: 1,}]}>
                        <View style = {{width: '100%', height: 30, flexDirection: 'row'}}>
                            ...
                            <View style = {{width: '50%', height: '100%', justifyContent: 'center', alignItems: 'flex-end'}}>
                                <RadioForm
                                    ...
                                    initial={this.state.paperRec == "N" ? 1 : 0}
                                    formHorizontal={true}
                        ...
                        <View style = {{width: '100%', height: 30, flexDirection: 'row'}}>
                            ...
                            <View style = {{width: '50%', height: '100%', justifyContent: 'center', alignItems: 'flex-end'}}>
                                <RadioForm
                                    radio_props={radio_props}
                                    initial={this.state.onlineRec == "N" ? 1 : 0}
                                    formHorizontal={true}
                                    labelHorizontal={true}
                                    buttonSize={15}
                                    buttonColor={'#ff954c'}
