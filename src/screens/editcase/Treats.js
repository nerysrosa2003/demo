...
export default class Treats extends Component {
    ...
    init_visit = () => {
        this.setState({
            ...
            prodiags_list: Global.edit_case_json.prodiags,
        })
    }
    ...
    select_right_menu = (index) => {
        var prodiags_list = this.state.prodiags_list;
        for(i = 0; i < prodiags_list.length; i ++) {
            if(i == index) {
                prodiags_list[i].clicked = !prodiags_list[i].clicked;
            } else {
                prodiags_list[i].clicked = false;
            }
        }
        this.setState({
            prodiags_list: prodiags_list
        });
    }
    ...
    show_alert(index) {
        ...
        [
            ...
            {text: 'OK', onPress: () => this.delete_treat(index)},
        ],
        { cancelable: true })
    }
        ...
        <SafeAreaView style = {styles.container}>
        {
            ...
            <View style = {{width: '100%', height: main_view_height, alignItems: 'center'}} onStartShouldSetResponder={() => this.hidden_right_menu()}>
                <ScrollView style = {{width: '90%'}} showsVerticalScrollIndicator = {false}>
                    ...
                    {
                        this.state.prodiags_list.map((item, index) => 
